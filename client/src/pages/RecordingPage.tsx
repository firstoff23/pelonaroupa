  ...
  return (
    <div className="page-enter min-h-full px-4 pt-6 pb-4 space-y-6 max-w-lg mx-auto select-none touch-callout-none">
      <div className="text-center space-y-1">
        <h1 className="text-2xl font-bold text-foreground">PetSense</h1>
        {activeAnimal ? (
      ...
      <div className="p-3.5 rounded-xl bg-amber-500/10 border border-amber-500/20 text-amber-200 text-xs flex items-start gap-2.5 shadow-sm text-left">
        ...
        <p className="leading-relaxed">
          <strong>Aviso:</strong> PetSense não substitui avaliação
      ...
      <p className="text-[10px] text-muted-foreground/60 text-center leading-relaxed max-w-[360px] mx-auto pt-4 pb-2">
        {language === "pt"
          ? "PetSense não substitui avaliação veterinária. Os resultados são estimativas comportamentais baseadas em áudio e contexto."
          : "PetSense does not replace veterinary evaluation. Results are behavioral estimates based on audio and context."}
      </p>
    </div>
  );
}
