...
- [ ] LangGraph + LangChain — agente que combina áudio + imagem + historial
...
- [ ] AGRICOLA / PubMed integration — contexto veterinário nas classificações
- [ ] Modelo fine-tuned por raça — classificador específico para Golden vs Husky

## Infraestrutura
- [ ] Rate limiting — proteção da API quando escalar
- [ ] Plano de preços — free tier vs premium
